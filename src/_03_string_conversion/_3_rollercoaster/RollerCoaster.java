...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		...
		// 2) Ask the user to enter their height in inches using JOptionPane 
		//and set it to the variable heightToRide
		...
		// Do you see the heightToRide > 42 underlined red? That is because you are comparing a STRING to an INTEGER.
				...
				// 3) Convert heightToRide to heightAsInt using Integer.parseInt();  Hint: 
					//int heightAsInt = Integer.parse... 
		...
		int heightAsInt = Integer.parseInt(heightToRide);
			if( heightAsInt >= 48 ) { 
				...
				JOptionPane.showMessageDialog(null, "hurray you are tall enough to ride alone");
			}
